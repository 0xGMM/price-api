from price_api.pricing import is_valid_symbol, format_price_response, format_price_list
...
def test_format_price_list():
    price_list = [{"id": "bitcoin", "symbol": "btc", "name": "Bitcoin", "current_price": 50000}, {"id": "bitcoin", "symbol": "eth", "name": "Ethereum", "current_price": 2000}]

    result_list = format_price_list(price_list)

    
    assert result_list == [{"symbol": "btc", "name": "Bitcoin", "price": 50000}, {"symbol": "eth", "name": "Ethereum", "price": 2000}]
